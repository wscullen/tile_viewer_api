...
def test_sen2agri_tasks_l3a():
    from worker.tasks import sen2agri_tasks_l3a
    ...
    task = sen2agri_tasks_l3a.start_l3a_job(imagery_list_example, "0", "Test AOI Name")
    print(task)


test_sen2agri_tasks_l3a()
